    ...
    <section class="destacados-section">
      ...
      <div class="destacados-cards">
        <div class="destacado-card">
          <div class="destacado-titulo">LOS</div>
          <img src="/Tienda_SNKRS/public/assets/img/jordan1n.jpg" alt="Nike Air" class="destacado-img">
          <a href="#" class="destacado-btn">COMPRAR AHORA</a>
        </div>
        <div class="destacado-card">
          <div class="destacado-titulo">MÁS</div>
          <img src="/Tienda_SNKRS/public/assets/img/yeezy.jpg" alt="Adidas Yeezy" class="destacado-img">
          <a href="#" class="destacado-btn">COMPRAR AHORA</a>
        </div>
        <div class="destacado-card">
          <div class="destacado-titulo">TOP</div>
          <img src="/Tienda_SNKRS/public/assets/img/jordan4.jpg" alt="New Balance" class="destacado-img">
          <a href="#" class="destacado-btn">COMPRAR AHORA</a>
        </div>
      </div>
    </section>
