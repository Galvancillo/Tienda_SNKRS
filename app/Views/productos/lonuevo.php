...
<head>
    ...
    <link rel="stylesheet" href="/Tienda_SNKRS/public/assets/css/lonuevo.css">
    <title>Lo Nuevo | SNKRS World</title>
</head>
<body>
    <nav class="navbar">
    ...
    <main style="flex:1 0 auto; padding: 40px 0 0 0; text-align:center;">
        <h1>ESTA PAGINA ES DE LO NUEVO</h1>
        <!-- Aquí va el contenido de la sección Lo Nuevo -->
    </main>
